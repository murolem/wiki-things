...
//         stareImg = await this.loadImage("/pick-up-moth-get-picked-up.gif");
...
//         // gen
//         let pixelsToChopOffCount = clamp(1000000000 * dt, 1, Infinity)
...
//             const xTo = Math.abs(Math.trunc((i - y) % 1000));
//             const yTo = Math.abs(Math.trunc((i - x) % 1000));
