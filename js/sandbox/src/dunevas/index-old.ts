...
//         const elapsedMs = frames / Vars.fps * 1000;

//         // const ts = Date.now();
//         // const elapsedMs = ts - initialTs;

//         const phaseDurationMs = 100;
//         const phaseNumberDirty = elapsedMs / phaseDurationMs;
//         const phaseNumber = clamp(Math.floor(phaseNumberDirty), 0, 200);
//         const phaseT = phaseNumber % 2 === 0
//             ? phaseNumberDirty % 1
//             : 1 - phaseNumberDirty % 1
//         // const phaseT = phaseNumberDirty % 1;

//         // const expiesPerRow = 2 ** phaseNumber;
//         // const expiesTotal = expiesPerRow * expiesPerRow;
//         // const expieSize = 1000 / expiesPerRow;
//         // const maxDiagonal = Math.sqrt(1000 ** 2 + 1000 * 2)

//         // p5.imageMode('center');

//         // const offsetMax = 500;
//         // const offset = phaseT * offsetMax;

//         // const size = clamp(1000 * phaseT, 0, 1000)// + sampleWobble(phaseT, 200, 1.1)
//         const size = 700;

//         // const shearX = Math.cos(Vars.ts / 100) * .2;
//         // const shearY = Math.sin((Vars.ts + 12312/3123) / 95) * .123;
//         // p5.shearX(shearX)
//         // p5.shearY(shearY)
//         // const scaleY = this.map(Math.sin((Vars.ts + 12312/3123) / 95 % Math.PI * 1) * 1, 0, 1, .5, 1)
//         // p5.scale(1, scaleY);
//         // p5.shearY((Vars.ts + 123144) / 10000)


//         // p5.image(stareImg, 500, 500 + scaleY * size / 6, size, size);

//         // gen
//         let pixelsToChopOffCount = clamp(10000000000 * dt, 1, Infinity)
//         // if(flyingPixels.size > 0)
//         // pixelsToChopOffCount = 0;
...
//         }
//         stareImgBuffer.updatePixels();
//         // console.log(flyingPixels.size)


//         // if(phaseT < lastPhaseT) {
//         //     megabitesPlayedForIdx.clear();
//         // }
//         // lastPhaseT = phaseT;


//         // for (let i = 0; i < expiesTotal; i++) {
//         //     const x = i % expiesPerRow * expieSize;
//         //     const y = Math.floor(i / expiesPerRow) * expieSize;
//         //     const distFromUpperLeft = Math.sqrt(x ** 2 + y ** 2);
//         //     const distT = distFromUpperLeft / maxDiagonal;
//         //     const startAppearAtPhaseT = this.map(distT, 0, 1, 0, .5);
//         //     const endAppearAtPhaseT = clamp(startAppearAtPhaseT + .3, 0, 1);
//         //     if (phaseT < startAppearAtPhaseT)
//         //         continue;

//         //     const opacityT = clamp(this.map(phaseT, startAppearAtPhaseT, endAppearAtPhaseT, 0, 1), 0, 1);
//         //     // if(i === expiesTotal - 1) {
//         //         // console.log(phaseT, startAppearAtPhaseT, endAppearAtPhaseT)
//         //     // }
//         //     const overlayCol = this.color(0, 1 - opacityT);
//         //     p5.image(stareImg, x, y, expieSize, expieSize);

//         //     p5.fill(overlayCol);
//         //     this.rect(x, y, expieSize, expieSize);

//         //     if(phaseT >= endAppearAtPhaseT - 0.05 && !megabitesPlayedForIdx.has(i)) {
//         //         playMegabite();
//         //         megabitesPlayedForIdx.add(i);
//         //     }
//         // }

//         // const overlayOpacityT = phaseT > .5 ? this.map(phaseT, .5, 1, 0, 1) : 0;
//         // const overlayCol = this.color(0, overlayOpacityT);
//         // p5.fill(overlayCol);
//         // this.rect(0, 0, 1000, 1000);
...
//     function sampleWobble(t: number, maxIntensity: number, totalWobbles: number) {
//         const tPerWobble = 1 / totalWobbles;
//         const wobbleIdxFloat = t / tPerWobble;
//         const wobbleT = wobbleIdxFloat % 1;

//         const intensityT = t;
//         const offset = Math.cos(wobbleT * Math.PI * 2) * (intensityT * maxIntensity)
//         return offset;
//     }
// });